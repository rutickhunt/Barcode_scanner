...
class AutoUpdateTask extends AsyncTask<Long, Void, String> {
    ...
    private final static String GET_BUNDLE_URL = "https://upd.appery.io/update/748a9507-d762-4831-b3ec-6eca19745a49.zip";
    
    private final static Long BUILD_TIMESTAMP_MILLISEC = 1454394871 * 1000L;
